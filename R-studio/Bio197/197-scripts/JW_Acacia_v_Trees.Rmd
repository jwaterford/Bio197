...
Acacia_sub <- subset(trees, SPECIES == "Acacia_etbaica" | SPECIES == "Acacia_drepanolobium" | SPECIES == "Acacia_brevispica" | SPECIES == "Acacia_mellifera")
other_sub <- subset(trees, SPECIES != "Acacia_etbaica" & SPECIES != "Acacia_drepanolobium" & SPECIES != "Acacia_brevispica" & SPECIES != "Acacia_mellifera")

trees$TreeType <- c("Acacia")

ggplot(trees, aes(x= CIRC, y= HEIGHT, colour = SPECIES)) +
  geom_point()
