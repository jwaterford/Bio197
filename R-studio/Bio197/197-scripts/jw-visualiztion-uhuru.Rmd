...
These *treaments* are different areas of Kenya, were predation levels (and species) are diversified.
...
acacia_csv <- ("../197-raw_storage/ACACIA_DREPANOLOBIUM_SURVEY.txt")
## add `na.strings = "dead"
