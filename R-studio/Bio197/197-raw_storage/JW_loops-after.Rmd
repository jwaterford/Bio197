...
#mapply(tree_volume_calc(species = #preload$SPECIES,height = prelaod$HEIGHT,axis1 = #preload$AXIS_1,axis2 = preload$AXIS_2)) -> #tree_volume
```
...
preload %>% 
  rowwise() %>% 
  mutate(volume = tree_volume_calc(species = SPECIES,height = HEIGHT,axis1 = AXIS_1,axis2 = AXIS_2)) -> tree_data
